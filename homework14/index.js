...
class User {
    ...
    render() {
        let UserInfo = `<div class="user__info">
        ...
        return `<div class="user">${UserInfo} ${this.courses ? this.renderCourses() : ``} </div>`
    }

    renderCourses() {
        let UserCourses = this.courses
            .map(course => {
        ...
        return `<div class="user__courses">${UserCourses}</div>`
    }
}
...
class Admin extends User {
    ...
    renderCourses() {
        ...
        return `<div class="user__courses ${this.role}--info">${UserCourses}</div>`
    }
}
...
document.write(`<div class="users">${usersRender}</div>`)
